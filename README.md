...
3. That's it. `pay.mmocoin.pro/downloads/plugins/<slug>` (currently wired for `xenforo`; vBulletin intentionally still points at its forum announcement thread instead) starts serving the new zip immediately.
