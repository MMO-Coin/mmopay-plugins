...
/*======================================================================*\
|| #################################################################### ||
|| # MMOCoin Pay Payment Gateway for vBulletin 6.x (v1.0.0)            # ||
|| # Platform: https://pay.mmocoin.pro                                 # ||
|| # Official Crypto & Subscription Payment Gateway for Solana/USDC/MMO# ||
|| # Compatible: vBulletin 6.x / PHP 7.4 / 8.x                         # ||
|| #                                                                    # ||
|| # This is the vBulletin 6 build of this gateway. vBulletin 6's own  ||
|| # distribution still ships a core/ folder with core/install/, the  ||
|| # same layout vBulletin 5 introduced -- the legacy Paid Subscriptions  ||
|| # system (vB_PaidSubscriptionMethod, the paymentapi/class_*.php     # ||
|| # pattern, Payment API Manager) was carried forward unchanged, so   # ||
|| # this file is install-path-identical to the vBulletin 5 build.    # ||
|| # It has been reviewed against vBulletin's own published Connect   # ||
|| # API documentation (which covers 6.1.0 directly), not against a   # ||
|| # live vBulletin 6 install -- test on a staging board before       # ||
|| # relying on it for real members.                                  # ||
|| #################################################################### ||
\*======================================================================*/
...
/*======================================================================*\
|| ####################################################################
|| # MMOCoin Pay Gateway Engine - v1.0.0 (vBulletin 6 build)
|| ####################################################################
\*======================================================================*/
?>
